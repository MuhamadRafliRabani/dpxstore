...
export default function ProductContent({ category_name, products, errors, data, setData }: productContentType) {
    switch (category_name) {
            ...
            return (
                <CardContent className="space-y-4 px-3.5 py-2">
                    {weeklyDiamondPass.length !== 0 && (
                        <div className="">
                            <div className="mb-2 flex w-full items-center gap-2">
                                <h1 className="text-accent-foreground text-sm font-medium md:font-medium">Weekly Diamond Pass</h1>
                    ...
                    {starlightProducts.length !== 0 && (
                        <div className="">
                            <div className="mb-2 flex w-full items-center gap-2">
                                <h1 className="text-accent-foreground text-sm font-medium md:font-medium">Starlight</h1>
                    ...
                    {otherProducts.length !== 0 && (
                        <div className="">
                            <h1 className="text-accent-foreground mb-2 flex items-center gap-1 text-sm font-medium">
                                Diamond <Diamond />
                            </h1>
                            <ul className="grid grid-cols-2 gap-4 sm:grid-cols-3">
            ...
            return (
                <CardContent className="space-y-4 px-3.5 py-2">
                    {internetProducts.map((product) => (
                        <div>
                            <div className="mb-2">
                                <h1 className="text-accent-foreground text-sm font-medium md:font-medium">Data Internet</h1>
                            </div>
                            <ul className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                                <li key={product.id}>
                                    <ProductCard
                    ...
                    {otherProducts.map((product) => (
                        <div>
                            <div className="mb-2">
                                <h1 className="text-accent-foreground text-sm font-medium md:font-medium">Pulsa</h1>
                            </div>
                            <ul className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                                <li key={product.id}>
                                    <ProductCard
        ...
        case 'voucher': {
            ...
            return (
                <CardContent className="px-1 py-0 sm:px-4">
                    <h1 className="text-primary mb-2 flex items-center gap-2 text-lg font-medium">Voucher</h1>
                    <ul className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        case 'tagihan': {
            ...
            return (
                <CardContent className="px-1 py-0 sm:px-4">
                    <h1 className="text-primary mb-2 flex items-center gap-2 text-lg font-medium">Anti ganguan</h1>
                    <ul className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                        {products.map((product) => (
                            <li key={product.id}>
                                <ProductCard
